...
const handleSubmit = (event) => {
    ...
    axios.post('http://localhost:9000/details' , values)
            ...
            <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
              ...
              <div className="my-2 w-1/2 lg:w-2/4">
                <button
                  type="submit"
                  id="submitBtn"
                  className="uppercase text-sm font-bold tracking-wide bg-black hover:bg-red-500 text-gray-100 p-3 rounded-lg w-full 
            ...
            <div className="flex flex-col text-white">
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-400">Tel: +91 120 421 7213</p>

                  <div className="mt-5">
                    <h2 className="text-2xl">Send an E-mail</h2>
                    <p className="text-gray-400">sales@keenable.in</p>
                  </div>
                </div>
              </div>
